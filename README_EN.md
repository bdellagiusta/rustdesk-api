...
displaying data.Frontend code is available at [rustdesk-api-web](https://github.com/bdellagiusta/dj3-api-web)
...
3. Build the admin front-end (the front-end code is
   ...
   cd resources
   mkdir -p admin
   git clone https://github.com/bdellagiusta/dj3-api-web
   cd rustdesk-api-web
   npm install
   npm run build
   cp -ar dist/* ../admin/
